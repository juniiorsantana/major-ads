...
const Sidebar: React.FC<SidebarProps> = ({ onLogout, activeTab, setActiveTab }) => {
  const menuItems = [
    ...
    { id: 'ai-tools', label: 'AI Optimizer', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    ...
    <aside className="w-64 bg-white border-r border-slate-200 h-screen sticky top-0 flex flex-col">
      <div className="p-6 border-b border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-slate-800">AdsManager Pro</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-100">
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-rose-500 hover:bg-rose-50 transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
